...
import com.codewithshubh.covid19.Adapters.DistrictWiseAdapter;
import com.codewithshubh.covid19.Adapters.StateWiseAdapter;
import com.codewithshubh.covid19.MainActivity;
import com.codewithshubh.covid19.R;
...
import static com.codewithshubh.covid19.Constants.STATE_NAME;
...
public class DistrictWiseDataActivity extends AppCompatActivity {
    ...
    private ArrayList<CountryWiseDataActivity.DistrictWiseModel> districtWiseModelArrayList;
    ...
    private void Filter(String s) {
        ArrayList<CountryWiseDataActivity.DistrictWiseModel> filteredList = new ArrayList<> ();
        for (CountryWiseDataActivity.DistrictWiseModel item : districtWiseModelArrayList) {
                            ...
                            for (int i=1;i<response.length();i++){
                                ...
                                if (str_state_name.toLowerCase().equals(jsonObjectState.getString("state").toLowerCase())){
                                    ...
                                    for (int j=0; j<jsonArrayDistrict.length(); j++){
                                        ...
                                        CountryWiseDataActivity.DistrictWiseModel districtWiseModel = new CountryWiseDataActivity.DistrictWiseModel (str_district, str_confirmed,
