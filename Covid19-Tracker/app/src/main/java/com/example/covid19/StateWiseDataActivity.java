...
public class StateWiseDataActivity extends AppCompatActivity {
    ...
    private ArrayList<EachCountryDataActivity.StateWiseModel> stateWiseModelArrayList;
    ...
    private void Filter(String text) {
        ArrayList<EachCountryDataActivity.StateWiseModel> filteredList = new ArrayList<>();
        for (EachCountryDataActivity.StateWiseModel item : stateWiseModelArrayList) {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            for (int i = 1; i < jsonArray.length() ; i++){
                                ...
                                EachCountryDataActivity.StateWiseModel stateWiseModel = new EachCountryDataActivity.StateWiseModel (str_state, str_confirmed, str_confirmed_new, str_active,
